...
* Fri Dec  3 2021 Dirk Müller <dmueller@suse.com>
...
* Wed May  5 2021 Dr. Werner Fink <werner@suse.de>
...
* Thu Nov 19 2020 Ludwig Nussel <lnussel@suse.de>
...
* Sat May  9 2020 Dr. Werner Fink <werner@suse.de>
...
* Sun Apr 19 2020 Thorsten Kukuk <kukuk@suse.com>
- Fix usage of update-alternatives
* Fri Apr  3 2020 Dr. Werner Fink <werner@suse.de>
- Add temporary patch bash50-fix-016-close-new-fifos.patch from upstream
  to fix upstream patch bash50-016
* Mon Feb 24 2020 Ludwig Nussel <lnussel@suse.de>
...
* Wed Oct 16 2019 Dr. Werner Fink <werner@suse.de>
...
- Do not recommend lang package. The lang package already has a
  supplements.
* Mon Sep  9 2019 Dr. Werner Fink <werner@suse.de>
...
* Tue Apr 23 2019 Dr. Werner Fink <werner@suse.de>
...
* Thu Apr  4 2019 Dr. Werner Fink <werner@suse.de>
- Add temporary fix from upstream for boo#1128936
* Thu Mar 21 2019 Dr. Werner Fink <werner@suse.de>
...
* Mon Mar 11 2019 Dr. Werner Fink <werner@suse.de>
- Update temporary patch from upstream to make sed testsuite
  work again
* Wed Mar  6 2019 Dr. Werner Fink <werner@suse.de>
- Requires(postun) -> Requires(preun)
* Tue Mar  5 2019 Dr. Werner Fink <werner@suse.de>
- Do not link /bin/sh as slave alternative to /usr/bin/sh
* Mon Mar  4 2019 Dr. Werner Fink <werner@suse.de>
...
* Fri Mar  1 2019 Dr. Werner Fink <werner@suse.de>
- Make update-alternatives work flawless
* Fri Feb  8 2019 Jan Engelhardt <jengelh@inai.de>
- Put "sh" under control of update-alternatives
* Thu Feb  7 2019 Dr. Werner Fink <werner@suse.de>
- Add upstream patches bash50-001 and bash50-002
* Wed Jan  9 2019 Dr. Werner Fink <werner@suse.de>
...
- Modify patches
  ...
  * bash-4.3-loadables.dif
  * bash-5.0.dif
* Fri Dec 21 2018 Dr. Werner Fink <werner@suse.de>
- Update to bash 5.0 rc1
  ...
  a. The `select' command now supports command forms without a word list
    following `in'.
* Thu Nov 29 2018 Dr. Werner Fink <werner@suse.de>
...
* Thu Sep 20 2018 Dr. Werner Fink <werner@suse.de>
